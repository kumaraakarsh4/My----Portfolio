...
        <div className="flex flex-col justify-center h-full text-center lg:text-left relative py-20 lg:py-0 order-2 lg:order-1"> {/* order-2/order-1 makes text appear first on mobile */}
...
        {/* Right Column: Avatar Image - FIX APPLIED HERE (removed 'hidden') */}
        <div className="relative flex justify-center h-full order-1 lg:order-2"> {/* order-1/order-2 makes image appear first on mobile, centered */}
          <div 
...
      className="absolute top-1/2 -translate-y-1/2 object-contain select-none pointer-events-none w-full max-w-sm lg:max-w-none"
      style={{
